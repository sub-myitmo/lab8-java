...
public class StudyGroup implements Comparable<StudyGroup>, Validatable, Serializable {
    ...
    private static final long serialVersionUID = 6421011289778521460L;
     ...
     */
    public StudyGroup(long id, String name, Coordinates coordinates, Date creationDate, Long studentsCount, Long expelledStudents, Integer transferredStudents, Semester semesterEnum, Person groupAdmin, User user) {
        this.id = id;//nextId++;
        this.name = name;
...
//    }
    ...
    public void update(StudyGroup studyGroup) {
        ...
        this.owner = studyGroup.getOwner();
    }
